...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (
    ...
    /******/
    {
      ...
      /***/
      function srcPluginsSortAnimationIndexJs(module, exports, __webpack_require__) {
        "use strict";

        eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.defaultOptions = undefined;\n\nvar _SortAnimation = __webpack_require__(/*! ./SortAnimation */ \"./src/Plugins/SortAnimation/SortAnimation.js\");\n\nvar _SortAnimation2 = _interopRequireDefault(_SortAnimation);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.default = _SortAnimation2.default;\nexports.defaultOptions = _SortAnimation.defaultOptions;\n\n//# sourceURL=webpack://Draggable/./src/Plugins/SortAnimation/index.js?");
        /***/
      },
      ...
      /***/
      "./src/shared/utils/distance/distance.js":
      /*!***********************************************!*\
        !*** ./src/shared/utils/distance/distance.js ***!
        \***********************************************/
      ...
      /***/
      function srcSharedUtilsDistanceDistanceJs(module, exports, __webpack_require__) {
        "use strict";

        eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = distance;\n/**\n * Returns the distance between two points\n * @param  {Number} x1 The X position of the first point\n * @param  {Number} y1 The Y position of the first point\n * @param  {Number} x2 The X position of the second point\n * @param  {Number} y2 The Y position of the second point\n * @return {Number}\n */\nfunction distance(x1, y1, x2, y2) {\n  return Math.sqrt((x2 - x1) ** 2 + (y2 - y1) ** 2);\n}\n\n//# sourceURL=webpack://Draggable/./src/shared/utils/distance/distance.js?");
        /***/
      },

      /***/
      "./src/shared/utils/distance/index.js":
      /*!********************************************!*\
        !*** ./src/shared/utils/distance/index.js ***!
        \********************************************/
      ...
      /***/
      function srcSharedUtilsDistanceIndexJs(module, exports, __webpack_require__) {
        "use strict";

        eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _distance = __webpack_require__(/*! ./distance */ \"./src/shared/utils/distance/distance.js\");\n\nvar _distance2 = _interopRequireDefault(_distance);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.default = _distance2.default;\n\n//# sourceURL=webpack://Draggable/./src/shared/utils/distance/index.js?");
        /***/
      },
      ...
      /***/
      function srcSharedUtilsTouchCoordsIndexJs(module, exports, __webpack_require__) {
        "use strict";

        eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _touchCoords = __webpack_require__(/*! ./touchCoords */ \"./src/shared/utils/touchCoords/touchCoords.js\");\n\nvar _touchCoords2 = _interopRequireDefault(_touchCoords);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.default = _touchCoords2.default;\n\n//# sourceURL=webpack://Draggable/./src/shared/utils/touchCoords/index.js?");
        /***/
      },

      /***/
      "./src/shared/utils/touchCoords/touchCoords.js":
      /*!*****************************************************!*\
        !*** ./src/shared/utils/touchCoords/touchCoords.js ***!
        \*****************************************************/
...
var _debounce = _interopRequireWildcard(__webpack_require__(/*! ../../scripts/utils/debounce */ "../src/scripts/utils/debounce.js"));
...
var MobileNav = /*#__PURE__*/function () {
  ...
  _createClass(MobileNav, [{
    ...
    value: function init() {
      ...
      if (!this.target) {
        console.log('The activator must have a valid `aria-controls` value. Target not found.');
        return;
      }
      ...
      window.addEventListener('resize', (0, _debounce.default)(function () {
        _this._setState();
    ...
    value: function _setState() {
      var windowWidth = document.documentElement.clientWidth; // currently collapses when resizing within any mobile range...
...
var _flipSign = _interopRequireDefault(__webpack_require__(/*! ../../scripts/utils/flip-sign */ "../src/scripts/utils/flip-sign.js"));
...
var Plate = /*#__PURE__*/function () {
  ...
  _createClass(Plate, [{
    ...
    value: function setThreshold() {
      ...
      this.threshold = {
        min: (0, _flipSign.default)(newThreshold),
        max: newThreshold
      };
    }
  }, {
    ...
    value: function _scalePlates(x, y) {
      ...
      this.wrapper.style.setProperty('--plate-scale-x', "".concat(scaleX));
      this.wrapper.style.setProperty('--plate-scale-y', "".concat(scaleY));
    }
  }, {
    ...
    value: function _translateEachPlate(x, y) {
      for (var plateLevel in this.plates) {
        ...
        if (this.plates.hasOwnProperty(plateLevel)) {
          var translateX = (0, _flipSign.default)(x * 2) * translateFactors[plateLevel];
          var translateY = (0, _flipSign.default)(y * 2) * translateFactors[plateLevel];
          this.wrapper.style.setProperty("--".concat(plateLevel, "-translate-x"), "".concat(translateX, "px"));
          this.wrapper.style.setProperty("--".concat(plateLevel, "-translate-y"), "".concat(translateY, "px"));
        }
      }
    }
  }, {
    ...
    value: function _translateShadow(x, y) {
      this.wrapper.style.setProperty('--shadow-offset-x', "".concat(x / 2, "px"));
      this.wrapper.style.setProperty('--shadow-offset-y', "".concat(y / 2, "px"));
    }
  }]);
...
function translateMirror(mirror, mirrorCoords, containerRect) {
  ...
  requestAnimationFrame(function () {
    mirror.style.transform = "translate3d(".concat(mirrorCoords.left, "px, ").concat(mirrorCoords.top, "px, 0)");
  });
}
...
function DragEvents() {
  ...
  var dragThreshold;
  var headings;
  var headingText; // --- Draggable events --- //
  ...
  draggable.on('mirror:move', function (evt) {
    ...
    evt.cancel(); // We do not want to use `getBoundingClientRect` while dragging,
  ...
  var triggerMouseUpOnESC = function triggerMouseUpOnESC(evt) {
    if (evt.key === 'Escape') {
      draggable.cancel();
    }
  };
...
function UniqueDropzone() {
  ...
  var droppableOrigin; // --- Draggable events --- //
...
var _Plate = _interopRequireDefault(__webpack_require__(/*! ../../components/Plate */ "../src/components/Plate/index.js"));
...
function Home() {
  ...
  var plates = new _Plate.default(container); // --- Draggable events --- //
...
function PluginsCollidable() {
  ...
  var walls = document.querySelectorAll(".".concat(wallClass));
...
/***/ "../src/content/Plugins/SortAnimation/index.js":
/*!*****************************************************!*\
  !*** ../src/content/Plugins/SortAnimation/index.js ***!
  \*****************************************************/
/*! no static exports found */
...
function SortAnimation() {
  var containers = document.querySelectorAll('#SortAnimation .BlockLayout');
  ...
  var sortable = new _draggable.Sortable(containers, {
    ...
    plugins: [_draggable.Plugins.SortAnimation],
    swapAnimation: {
      duration: 200,
      easingFunction: 'ease-in-out'
    }
...
function MultipleContainers() {
  ...
  var sortable = new _draggable.Sortable(containers, {
    draggable: ".".concat(Classes.draggable),
    mirror: {
      constrainDimensions: true
    },
    plugins: [_draggable.Plugins.ResizeMirror]
  });
  var notContainerCapacity = 1;
  var notContainerParent = sortable.containers[3].parentNode;
  ...
  sortable.on('drag:start', function (evt) {
    ...
    var label = evt.data.source.childNodes[0].childNodes[0].innerHTML;
    ...
    lastDragEvent[label] = now;
    currentNotChildren = sortable.getDraggableElementsForContainer(sortable.containers[3]).length;
    capacityReached = currentNotChildren === notContainerCapacity;
  ...
  sortable.on('sortable:sort', function (evt) {
    ...
    var sourceIsCapacityContainer = evt.dragEvent.sourceContainer === sortable.containers[3];

    if (!sourceIsCapacityContainer && evt.dragEvent.overContainer === sortable.containers[3]) {
      evt.cancel();
    }
  });
  sortable.on('sortable:sorted', function (evt) {
    ...
    if (currentActiveCount != lastActiveCount) {
      ...
      for (var i = 0; i < currentActiveCount; i++) {
        ...
        console.log('rule[' + i + ']=label=' + label + ',rule=' + rule);
      }
...
var _Home = _interopRequireDefault(__webpack_require__(/*! ./Home */ "../src/content/Home/index.js"));

var _DragEvents = _interopRequireDefault(__webpack_require__(/*! ./Draggable/DragEvents */ "../src/content/Draggable/DragEvents/index.js"));

var _UniqueDropzone = _interopRequireDefault(__webpack_require__(/*! ./Droppable/UniqueDropzone */ "../src/content/Droppable/UniqueDropzone/index.js"));

var _SimpleList = _interopRequireDefault(__webpack_require__(/*! ./Sortable/SimpleList */ "../src/content/Sortable/SimpleList/index.js"));

var _Transformed = _interopRequireDefault(__webpack_require__(/*! ./Sortable/Transformed */ "../src/content/Sortable/Transformed/index.js"));

var _MultipleContainers = _interopRequireDefault(__webpack_require__(/*! ./Sortable/MultipleContainers */ "../src/content/Sortable/MultipleContainers/index.js"));

var _Flexbox = _interopRequireDefault(__webpack_require__(/*! ./Swappable/Flexbox */ "../src/content/Swappable/Flexbox/index.js"));

var _Floated = _interopRequireDefault(__webpack_require__(/*! ./Swappable/Floated */ "../src/content/Swappable/Floated/index.js"));

var _GridLayout = _interopRequireDefault(__webpack_require__(/*! ./Swappable/GridLayout */ "../src/content/Swappable/GridLayout/index.js"));

var _Collidable = _interopRequireDefault(__webpack_require__(/*! ./Plugins/Collidable */ "../src/content/Plugins/Collidable/index.js"));

var _Snappable = _interopRequireDefault(__webpack_require__(/*! ./Plugins/Snappable */ "../src/content/Plugins/Snappable/index.js"));

var _SwapAnimation = _interopRequireDefault(__webpack_require__(/*! ./Plugins/SwapAnimation */ "../src/content/Plugins/SwapAnimation/index.js"));

var _SortAnimation = _interopRequireDefault(__webpack_require__(/*! ./Plugins/SortAnimation */ "../src/content/Plugins/SortAnimation/index.js"));
...
var Content = {
  Home: _Home.default,
  DragEvents: _DragEvents.default,
  UniqueDropzone: _UniqueDropzone.default,
  SimpleList: _SimpleList.default,
  Transformed: _Transformed.default,
  MultipleContainers: _MultipleContainers.default,
  Flexbox: _Flexbox.default,
  Floated: _Floated.default,
  GridLayout: _GridLayout.default,
  PluginsCollidable: _Collidable.default,
  PluginsSnappable: _Snappable.default,
  PluginsSwapAnimation: _SwapAnimation.default,
  PluginsSortAnimation: _SortAnimation.default
};
...
var _Analytics = _interopRequireDefault(__webpack_require__(/*! ../components/Analytics */ "../src/components/Analytics/index.js"));

var _MobileNav = _interopRequireDefault(__webpack_require__(/*! ../components/MobileNav */ "../src/components/MobileNav/index.js"));

var _content = _interopRequireDefault(__webpack_require__(/*! ../content */ "../src/content/index.js"));
...
var gtagTracking = new _Analytics.default('UA-107063633-1');
gtagTracking.init(); // Initialize navigation
//const mobileNav = new MobileNav(document.getElementById('MobileNavActivator'));
//mobileNav.init();
// Initialize all examples

for (var Example in _content.default) {
  // eslint-disable-next-line no-prototype-builtins
  if (_content.default.hasOwnProperty(Example)) {
    _content.default[Example]();
  }
}
...
exports.debounceDuration = void 0;
...
var debounceDuration = 60 * 6;
exports.debounceDuration = debounceDuration;
...
},[["../src/scripts/examples-app.js","examples-runtime"]]]);
