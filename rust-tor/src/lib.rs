...
caret_int! {
		/// A RelayCmd is the type of a relay cell.  The value of the RelayCmd
		/// indicates the meaning of the relay cell, and (possibly) its length.
		pub struct RelayCmd(u8) {
				/// reply to an EXTEND2 command
				EXTENDED2 = 15,
	}
}
